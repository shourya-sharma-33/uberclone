...
import placeholder1 from '../assets/pl2.jpeg'
    ...
    return (
        <div className=''>
            <div className=''>
                ...
                <h3 className="text-3xl font-semibold mb-5">Finish Ride</h3>
                ...
                /> */}
                    ...
                    <div className="mt-6 w-full">
                            ...
                            <Link to="/home" className="w-full mt-5 flex justify-center bg-green-600 text-white font-semibold p-3 rounded-lg">Finish</Link>
                            <button onClick={() => {
